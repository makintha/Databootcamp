...
'                Stock_Total = Stock_Total + ws.Cells(i, 7).Value
        ...
        For j = 2 To NTicker
            ...
            If Opening = 0 And Closing = 0 Then
                ...
                MsgBox ("NOTICE:" & vbCrLf & "This Worksheet has incomplete dataset" & vbCrLf & "The Problem data is at Ticker = " & ws.Cells(j, 9).Value)
                
                ws.Cells(6, 15).Value = "WARNING INCOMPLETE DATASET FOR TICKER = " & ws.Cells(j, 9).Value
